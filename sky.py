...
class Rain:
	def __init__(self, all_sprites):
		...
		self.rain_drops = import_folder('s1 - setup/graphics/rain/drops/')
		self.rain_floor = import_folder('s1 - setup/graphics/rain/floor/')
		self.floor_w, self.floor_h = pygame.image.load('s1 - setup/graphics/world/ground.png').get_size()
